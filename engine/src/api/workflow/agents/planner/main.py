...
class PlannerAgent(BaseAgent):
    ...
    async def create_discovery_plan(
        ...
        """
        logger.info(f"Creating discovery plan for query: {query}")
        ...
        try:
            ...
            logger.info(f"Found {len(tool_info)} valid tools for discovery")
            ...
            logger.info(f"Generated discovery plan: {discovery_plan}")
    ...
    async def analyze_query(
        ...
        """
        logger.info(f"Analyzing query with discovery context: {query}")
        ...
        try:
            ...
            logger.info(f"Found {len(tool_info)} valid tools")
            ...
            logger.info(f"Main plan generated: {plan}")
            ...
            logger.info(f"Generated optimized plan: {plan}")
            return plan
