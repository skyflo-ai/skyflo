...
export async function updateUserProfile(data: {
  ...
  try {
    ...
    console.log(`updateUserProfile authToken: ${JSON.stringify(authToken)}`);
    ...
    console.log(`updateUserProfile response: ${JSON.stringify(response)}`);
...
export async function changePassword(data: {
  ...
  try {
    ...
    console.log(`changePassword authToken: ${JSON.stringify(authToken)}`);
