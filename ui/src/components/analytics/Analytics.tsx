...
export default function Analytics() {
    ...
    return (
        <div className="flex flex-col gap-5 h-full overflow-auto px-2 py-2  bg-dark-bg text-text-primary">
            ...
            {displayData && (
                <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-8">
                        ...
                        <div className="bg-navbar rounded-lg border border-slate-700/60 p-8 shadow-lg">
                            <h3 className="text-xl font-semibold mb-4 text-text-primary">Time To First Token (TTFT)</h3>
                            <TimetoFirstTokenAreaChart data={displayData.daily_breakdown} />
                        </div>
                        <div className="bg-navbar rounded-lg border border-slate-700/60 p-8 shadow-lg">
                            <h3 className="text-xl font-semibold mb-4 text-text-primary">Total Response Time (TTR)</h3>
