                                          ...
                                          <div className="mb-2">
                                            ...
                                            {step.details.outputs.map(
                                              (output, i) => (
                                                <motion.div
                                                  key={i}
                                                  className="mb-2 border border-emerald-700/30 rounded-md overflow-hidden shadow-md"
                                                  initial={{
                                                    opacity: 0,
                                                    y: 10,
                                                  }}
                                                ...
                                                >
                                                  <div className="bg-[#0A1525] p-2 text-emerald-300 font-mono text-xs border-b border-emerald-700/30 flex justify-between items-center">
                                                    <code>Final Response</code>
                                                    <span className="text-[10px] text-slate-500">
                                                      {new Date(
                                                        output.timestamp
                                                      ).toLocaleTimeString()}
                                                  ...
                                                  <pre className="text-emerald-300 font-mono bg-[#0A1525]/70 p-2 rounded-b-md overflow-x-auto max-w-full text-xs break-all whitespace-pre-wrap">
                                                    {output.output ||
                                                      "No output"}
                                                  </pre>
                                                </motion.div>
