      ...
      <form onSubmit={handleSubmit} className="relative w-full">
        <div className="w-full relative">
          ...
          >
            <div className="relative w-full group">
              <div className="relative rounded-[28px] p-[1.5px] transition-colors duration-200 lg-wrapper">
                <div className="relative flex items-center rounded-[28px] backdrop-blur-2xl backdrop-saturate-150 shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-1px_0_rgba(0,0,0,0.35),0_8px_24px_-12px_rgba(0,0,0,0.6)]">
