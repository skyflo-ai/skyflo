...
export async function PATCH(request: NextRequest) {
  try {
    ...
    console.log("[API Route] Profile update with data:", data);

    const result = await updateUserProfile(data);
    console.log("[API Route] Profile update result:", result);
...
export async function POST(request: NextRequest) {
  try {
    const data = await request.json();
    console.log("[API Route] Password change request received");
    ...
    console.log("[API Route] Password change result:", result);
