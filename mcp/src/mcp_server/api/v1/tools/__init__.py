...
async def get_tool_by_path(category: ToolCategory, tool_name: str):
    ...
    try:
        ...
        print(f"Getting tool: {tool_name} in category {category}")
...
async def execute_tool_by_path(
    ...
    try:
        ...
        print(f"Tool exists: {tool_exists}")
        ...
        print(
            f"Executing tool: {tool_name} in category {category} with parameters: {parameters}"
        )
